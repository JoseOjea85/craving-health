...
function PageMeditacion() {
  ...
  const sessions = [
    { id: 1, title: 'Respiración 4-7-8', duration: '1 min', target: 60, emoji: '🌬️', desc: 'Inhala 4s, retén 7s, exhala 8s. Calma instantánea.', gradient: 'linear-gradient(135deg, #60a5fa, #22d3ee)', shape: 'circles' },
    { id: 4, title: 'Gratitud matinal', duration: '1 min', target: 60, emoji: '🌱', desc: 'Tres cosas por las que estás agradecido hoy.', gradient: 'linear-gradient(135deg, #4ade80, #22d3ee)', shape: 'leaves' },
    { id: 5, title: 'Mantra de fuerza', duration: '1 min', target: 60, emoji: '💪', desc: 'Soy más fuerte que este impulso.', gradient: 'linear-gradient(135deg, #ef4444, #fb923c)', shape: 'triangles' },
  ];
...
function Achievements({ sobrietyDays, workouts, diary, lang }) {
  ...
  const badges = [
    ...
    { id: 13, emoji: '🌟', title: lang === 'en' ? 'Two years' : 'Dos años', desc: lang === 'en' ? '730 days sober' : '730 días en abstinencia', unlocked: sobrietyDays >= 730 },
    { id: 14, emoji: '💎', title: lang === 'en' ? 'Three years' : 'Tres años', desc: lang === 'en' ? '1095 days sober' : '1095 días en abstinencia', unlocked: sobrietyDays >= 1095 },
    { id: 15, emoji: '🔱', title: lang === 'en' ? 'Four years' : 'Cuatro años', desc: lang === 'en' ? '1460 days sober' : '1460 días en abstinencia', unlocked: sobrietyDays >= 1460 },
